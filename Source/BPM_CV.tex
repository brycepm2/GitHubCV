...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{0.85in}} r }
Programming Languages &  C++, Tcl, Python, MATLAB, Wolfram Language \\
Software \& Tools & PyTorch, OpenMP, MPI, GNU Emacs, Abaqus, Patran/NASTRAN \\
Areas of Focus & Solid Mechanics, Multiphysics Simulation, Composite Materials \\
\end{tabular}
...
\item Establish communication pipeline between Abaqus and research code for nonintrusive coupling of simulations 
