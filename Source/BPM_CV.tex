...
\begin{rSection}{Education}
  ...
  % UIUC
{\bf The University of Illinois at Urbana-Champaign} \hfill {Overall GPA: 3.77/4.00} 
% PhD
...
% UB Bachelor
{\bf The State University of New York at Buffalo} \hfill {\em August 2015 - May 2017} 
\\ Bachelor of Science, \textit{summa cum laude}, Civil Engineering \hfill { Overall GPA: 3.88/4.00}
...
Software \& Tools & PyTorch, CGAL, Abaqus, Patran/NASTRAN \\
Areas of Focus & Finite Element Method, Damage \& Fracture Mechanics, Multiphysics Simulation \\
\end{tabular}
...
\item Develop and implement algorithms for mathematical models in FEM-based solid mechanics research code
\item Build CAD models and meshes of 3D bodies and 2D features in various preprocessing software
\item Utilize computational geometry library CGAL to capture solid-surface interactions in numerical models
...
\item Extract results from numerical simulations and analyze data to develop conclusions
\end{rSubsection}
...
%
\item Planned a multi-step computational project based on experimental
  phenomenon
    %
\item Developed and tested material models for high-speed applications
  in cutting-edge commercial tools
    %
\item Documented working and learning processes of model development
  to support future endeavors
    %
\item Conducted and communicated strength evaluation of an aerobody
  preceding flight testing
    %
\item Reviewed aerobody design drawings for accuracy and clarity
...
\bibliographystyle{shortRef}
\begin{rSection}{Publications (Title. {\em Journal.} DOI.)}{}
\begin{rSubsection}{}{}{}{}
