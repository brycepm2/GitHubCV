...
Areas of Focus & Solid Mechanics, Computational Mechanics, Partial Differential Equations \\
\end{tabular}
...
\item Develop and implement algorithms for mathematical models based on solid mechanics literature 
\item Perform tests to verify and validate software tools used to solve partial differential equations
