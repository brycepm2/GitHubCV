...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{25pt}} r }
Programming Languages &  C++, Tcl, Python, MATLAB, Wolfram Language \\
Software \& Tools & Git, OpenMP, MPI, Object-Oriented Programming, PyTorch \\
Areas of Focus & Computational Mechanics, Multiphysics Simulation, Software Development \\
\end{tabular}
...
\item Develop and implement algorithms for mathematical models in computational mechanics research code
\item Design and develop material model software for use with commercial finite element solver 
\item Author tests and tutorials for coupled fluid-structure interaction module of research code
\item Perform tests to verify and validate software tools in a finite element analysis code
\item Maintain functionality of large, evolving, parallel C++ research code across multiple operating systems
...
\item Developed and tested material models for high-speed applications in cutting-edge commercial tools
    %
\item Logged working and learning processes of model development to support future endeavors
    %
...
\item Reviewed aerobody design drawings for accuracy and clarity before sending to manufacturer
    %
\item Documented multiphysics analysis procedure for high-speed aircraft based on discussion with expert engineers
\end{rSubsection}
%------------------------------------------------
\end{rSection}
%----------------------------------------------------------------------------------------
